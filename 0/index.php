        ...
        <div class="wrapper">
            <main>
                ...
                <div class="quiz-box">
                    <div class="step-box step step-base" data-step="base">
                        <div class="step-content">
                            ...
                            <div class="btns-box">
                                <a href="javascript:void(0);" data-btn-status="ok" data-btn-step="base" class="btn btn-lg btn-simple js-btn-continue js-btn-quiz toUppercase">Chat now</a>
                            </div>
                        </div>
                    </div>
					<div class="step-box step step-checkboxes step-startQuiz"  data-step="1">
						<div class="step-content">
                            ...
                            <div class="btns-box">
                                <a href="javascript:void(0);" data-btn-status="continue" data-btn-step="1" class="btn btn-lg btn-simple js-btn-continue js-btn-quiz toUppercase">Continue</a>
                            </div>
						</div>
					</div>
					<div class="step-box step step-checkboxes step-finishQuiz"  data-step="finishQuiz">
						<div class="step-content">
							...
							<div class="btns-box">
                                <a href="javascript:void(0);" data-btn-status="continue" data-btn-step="finishQuiz" class="btn btn-lg btn-simple js-btn-continue js-btn-quiz toUppercase">Continue</a>
							</div>
						</div>
					</div>
                </div>
                ...
                <div class="form-register" id="form-register">
                    ...
                    <form class="step-box step mini-reg-form register-step-1" data-step="email">
                        <div class="step-content">
                            ...
                            <div class="btns-box">
                                <button data-btn-step="register-step-1" data-btn-status="continue" class="btn btn-lg btn-success">Continue</button>
                            </div>
                        </div>
                    </form>

                    <form class="step-box step mini-reg-form register-step-2" data-step="name">
                        <div class="step-content">
                            <div class="head head-title">
                                <a href="/mv.php?url=<?php echo urlencode(OWN_DOMAIN . '/sign-up'); ?>" class="header__logo df">
                                    <img src="images/logo-inverse.png" alt="BestBride Online Dating Site with Best Looking Women" class="logo-image img-fluid" />
                                </a>
                                <div class="counter">2 of 3</div>
                            </div>
                            <div class="title">Сonfirm or edit name <br> would you like to use on the website</div>
                            <div class="info">
                                <input type="text" name="name" minlength="2" class="input input-reg-name input-group-lg" placeholder="name" required="" />
                            </div>
                            <div class="btns-box">
                                <button data-btn-step="register-step-2" data-btn-status="continue" class="btn btn-lg btn-success">Сonfirm</button>
                            </div>
                        </div>
                    </form>

                    <form class="step-box step mini-reg-form register-step-3" data-step="password" data-final="true">
                        <div class="step-content">
                            <div class="head head-title">
                                <a href="/mv.php?url=<?php echo urlencode(OWN_DOMAIN . '/sign-up'); ?>" class="header__logo df">
                                    <img src="images/logo-inverse.png" alt="BestBride Online Dating Site with Best Looking Women" class="logo-image img-fluid" />
                                </a>
                                <div class="counter">3 of 3</div>
                            </div>

                            <div class="title">I am waiting for you<br> <span class="toUppercase" style="color: #af54ac; font-weight: bold;">Join now</span></div>
                            <div class="info">
                                <div class="info-img">
                                    <img src="images/finish.gif" alt="girl" />
                                </div>
                                <div class="text text-inner">Create password</div>
                                <div class="form-group">
                                    <input type="password" name="pass" class="input input-reg-password input-group-lg" placeholder="password" minlength="5" required />
                                </div>
                                <div class="form-group">
                                    <div class="terms-checkbox df aic jcc">
                                        <input type="checkbox" id="terms-agree" name="terms-agree" checked="" required="" />
                                        <label for="terms-agree ml-2">I have read, understand and agree to <a  href="/mv.php?url=<?php echo urlencode(OWN_DOMAIN . '/terms-and-conditions'); ?>" target="_blank">site rules</a></label>
                                    </div>
                                </div>
                            </div>
                            <div class="btns-box">
                                <button data-btn-step="register-step-5" data-btn-status="sign up" class="btn btn-lg btn-success">Sign up</button>
                            </div>
                        </div>
                    </form>
        ...
        <script>
            ...
            $(".mini-reg-form").on("submit", function (e) {
                ...
                if ($this.hasClass("register-step-1")) {
                    ...
                    let cutForName = data.answer.split('@')[0];
                    $(".input-reg-name").val(cutForName)
                }

                if ($this.hasClass("register-step-2")) {
                    let name = $this.find(".input").val();
                    let regexEng = /^[a-zA-Z0-9 ]+$/;
                    if (!regexEng.test(name)) {
                        Msg.error("Only letters (A - Z, a - z, 0-9) are allowed");
                        $this.addClass("error");
                    } else {
                        data.answer = $(".input-reg-name").val();
                    }
                }

                if ($this.hasClass("register-step-3")) {
                    data.answer = $(".input-reg-password").val();
                }
